...
class ChestXray14Dataset(Dataset):
    def __init__(self, dataframe, transform=None):
        ...
        self.underrepresented_diseases = ['Hernia', 'Pneumonia', 'Fibrosis', 'Emphysema', 'Cardiomegaly', 'Pleural_Thickening', 'Consolidation', 'Pneumothorax', 'Mass', 'Nodule']
        ...
        self.underrepresented_diseases_indices = [self.labels.index(disease) for disease in self.underrepresented_diseases]
