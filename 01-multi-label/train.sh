...
for MODEL in "${MODELS[@]}"; do
    for LOSS in "${LOSSES[@]}"; do        
        ...
        EXPERIMENT_NAME="${EXPERIMENT_NAME}-e$NUM_EPOCHS-bs$BATCH_SIZE-agb$ACCUMULATE_GRAD_BATCHES-lr$LEARNING_RATE-$NORMALIZATION-$DESCRIPTION"
